...
def make_record(**kwargs) -> FareRecord:
    defaults = dict(
        route="DEL-BOM", airline="IndiGo", flight_number="6E-123",
        cabin_class="economy", departure_date=date(2026, 9, 1),
        booking_window=7, base_fare=3500.0, fuel_surcharge=500.0,
        udf=None, psf=None, gst=None, total_fare=4200.0,
        source="indigo_direct", source_url=None,
    )
