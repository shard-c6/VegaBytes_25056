...
Scrapes non-stop economy fares from Air India.
    ...
    def scrape_route(
        ...
        with sync_playwright() as p:
            ...
            if not records:
                ...
                try:
                    # Update these fallback container classes after inspecting Air India DOM
                    html_fragment = page.inner_html(".search-results, .flight-list", timeout=5000)
                except Exception:
